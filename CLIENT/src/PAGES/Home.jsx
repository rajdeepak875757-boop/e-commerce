...
const Home = () => {
 ...
 console.log(product)
  ...
  return (
    ...
    <Productdata/>
    {/* section first */}
     <div className='h-[80vh] mt-12 flex'>
       <div className='w-[25vw] h-[79vh] bg-white pt-7 px-10 leading-7 md:leading-13 lg:leading-13 lg:text-[22px]  md:text-[22px] font-semibold '>
          <ul>
       ...
       <div className='flex justify-center items-center '>
         <img src={banner} alt="img" className='h-[79vh] pt-2 w-[75vw]' />
       </div>
     </div>
     ...
     <div className='py-5 px-10'>
        <div>
           ...
           <div className='text-center px-5 flex justify-between'>
